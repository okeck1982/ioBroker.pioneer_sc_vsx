...
class PioneerScVsx extends utils.Adapter {
	...
	async onReady() {
		...
		await this.setObjectNotExistsAsync("audio.buttonVolumeUp", {  _id: "audio.buttonVolumeUp", type: "state", common: { name: "ButtonVolumeUp", type: "boolean", role: "button", read: false, write: true }, native: {}});
		await this.setObjectNotExistsAsync("audio.buttonVolumeDown", {  _id: "audio.buttonVolumeDown", type: "state", common: { name: "ButtonVolumeDown", type: "boolean", role: "button", read: false, write: true }, native: {}});
