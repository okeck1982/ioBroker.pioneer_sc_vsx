...
class PioneerScVsx extends utils.Adapter {
	...
	async onReady() {
		...
		await this.setObjectNotExistsAsync("audio.buttonVolumeUp", {  _id: "audio.buttonVolumeUp", type: "state", common: { name: "turn up volume", type: "boolean", role: "button", read: true, write: true }, native: {}});
		await this.setObjectNotExistsAsync("audio.buttonVolumeDown", {  _id: "audio.buttonVolumeDown", type: "state", common: { name: "turn down volumen", type: "boolean", role: "button", read: true, write: true }, native: {}});
